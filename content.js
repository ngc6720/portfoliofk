const CONTENT = Object.freeze({
    ...
    about: {
        ...
        bio: "is an independant sound and interface designer with special interest in interactive systems. His artistic and musical background combined with design and programming abilities lead him to work in a variety of contexts. ",
    ...
    projects: [
        {
            ...
            p: [
                    "'Iris' is a music composition that offers fragmented soundscapes for the listener to wander in. It is imagined as a sound installation where layers of sounds spread in the space.",
        ...
        },
        {
            ...
            name: "Psyk",
            href: '/psyk',
            url: "https://www.ghu-paris.fr/fr/actualites/psy-son",
            audio: '',
            idObject: {
                name: "Psyk",
                date: "2021",
            ...
            p: [
                    "'Psyk' is a web application made for music discovery and playlists creation in the context of psychiatric caretaking.",
                    ...
                    "The web application offers several ways to find music and nudge the generated playlists using musical and emotional parameters."
            ]
        },
        {
            meta: {
            ...
            p: [
                    "'Ksora' is a digital musical instrument. It can welcome multiple users on an interface that let us play and mix several sounds together."
            ]
        },
        {
            meta: {
            ...
            p: [
                    "'Boîte à tubes' is a sound installation by artist Nadine Schütz. It allows visitors to perform, record and send a digital musical postcard. Sound material from the past, present and future highlights the story of the place welcoming the installation – an ancient factory.",
            ]
        },
        {
            meta: {
            ...
            audio: './media/errance-et-rois.mp3',
            idObject: {
                name: "Errance et Rois",
                date: "2019",
                type: "Sound walk",
        ...
        },
        {
            ...
            p: [
                    "'Echotopie' is a sound installation where attendants are immerged in a rainforest soundscape. The participants gestures can alter the composition and disrupt the soundscape, intentionally or unintentionally."
            ]
        },
        {
            meta: {
            ...
            p: [
                    "An 'Éclusophone' can be found found during a promenade along the canal of Bourgogne. Rattles and clatters emanating from this metallic instrument thanks to several handles and crank arms will surprise and intringue passerbies.",
            ]
        },
    ],
