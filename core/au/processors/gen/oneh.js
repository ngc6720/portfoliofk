...
class Oneh extends AudioWorkletProcessor {
    ...
    process(inputList, outputList, parameters) {   
        ...
        for (let smp = 0; smp < outputList[0][0].length; smp++)
        {
            ...
            outputList[0][0][smp] = ( this.#buffers[this.#current][0][this.#head] || 0) * parameters.gain[0] * this.#fadeRamp;
            outputList[0][1][smp] = ( this.#buffers[this.#current][1][this.#head] || 0) * parameters.gain[0] * this.#fadeRamp;
            ...
            if (this.#fadeRamp !== 0) {
                this.#head += 1;
                this.#head = clip(this.#head, 0, this.#buffers[this.#current][0].length);
