import { Vector2, PlaneGeometry, Mesh, MeshStandardMaterial, ClampToEdgeWrapping, RepeatWrapping, SRGBColorSpace, TextureLoader, DoubleSide, MeshPhongMaterial } from 'three'
...
const geometry = new PlaneGeometry( 16, 16, 16, 16 );
